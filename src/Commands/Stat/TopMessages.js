...
module.exports.execute = async (client, message, args) => {
    ...
    embed.setFooter("⚔ Assassins Developed by Synayzen İvar").setDescription(`${message.guild.name} sunucusunda kullanıcıların **${day}** gün boyunca yapmış olduğu mesaj aktifliği aşağıda detaylı olarak sıralanmıştır. Bir önceki güne gitmek için yöneticiye başvurunuz.`);
