    ...
    if (message.member.hasPermission("ADMINISTRATOR")) {
        ...
        if (seçim == "create") {
            ...
            */
            ...
            //#endregion
            let embed = new MessageEmbed().setFooter("⚔ Assassins Developed by Synayzen İvar").setTimestamp().setColor("33AFFF").setAuthor(message.author.username, message.author.avatarURL({ dynamic: true }));
