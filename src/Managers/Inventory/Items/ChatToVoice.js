...
class ChatToVoice extends Item {
    constructor(){
        super("CHATTOVOICE", "<:sesli:842034496161579009> Mesajı, Sese çevir!", "Üstünüzde bulunan ses aktivitesini kullanarak size sohbet mesajı ekler.", "USEABLE", "voiceStats");
